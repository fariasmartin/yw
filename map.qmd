...
<div class="layout">
  ...
  <div class="sidebar">
    ...
    <button id="findNearby" style="padding: 10px; width: 100%; margin-bottom: 1em;">📍 Find Centers Near Me (2 km)</button>
  </div>
...
// Detectar parámetro "city" en la URL
...
if (cityParam) {
  ...
  userLat = null;
  userLng = null;
  findNearbyBtn.textContent = "📍 Find Centers Near Me (2 km)";
...
findNearbyBtn.addEventListener("click", () => {
  if (!usingNearby) {
    ...
    navigator.geolocation.getCurrentPosition(pos => {
      ...
      input.value = "";
      findNearbyBtn.textContent = "✅ Showing Centers Near Me (2 km)";
      updateDisplay(true, true);
    }, () => {
...
input.addEventListener("focus", () => {
  ...
  showAll.textContent = "🌍 Show All Cities";
